...
/**
 * Utility class for detecting custom objects that should be converted to DTOs in nested object
 * handling.
 */
public class CustomObjectDetector {
  ...
  /**
   * Extracts the element type from collection types like {@code List<CustomObject>}. Returns the
   * element type that should be checked for DTO conversion.
   *
