...
public final class DefaultValueResolver {
    ...
    public static String getTypeSpecificValue(javax.lang.model.element.VariableElement field,
    ...
    public static String processAnnotationValue(javax.lang.model.element.VariableElement field,
                                         String fieldType,
    ...
    public static String processPrimitiveValue(javax.lang.model.element.VariableElement field,
                                        String fieldType,
                                        String annotationValue,
                                        javax.annotation.processing.Messager messager) {
    ...
    public static String processWrapperValue(javax.lang.model.element.VariableElement field,
                                      String fieldType,
                                      String annotationValue,
                                      javax.annotation.processing.Messager messager) {
        String fieldName = field.getSimpleName().toString();
    ...
    public static String processEnumValue(javax.lang.model.element.VariableElement field,
                                   String annotationValue,
                                   javax.annotation.processing.Messager messager) {
        String fieldName = field.getSimpleName().toString();
    ...
    public static boolean isCollectionType(String fieldType) {
        ...
        return base.equals(JAVA_UTIL_LIST) || base.equals(JAVA_UTIL_SET) || base.equals(JAVA_UTIL_MAP)
                || base.equals("List") || base.equals("Set") || base.equals("Map");
    }
    ...
    public static boolean isPrimitiveType(String fieldType) {
        return java.util.Arrays.asList(INTEGER_STRING, LONG_STRING, SHORT_STRING, BYTE_STRING, FLOAT_STRING, DOUBLE_STRING, BOOLEAN_STRING, "char").contains(fieldType);
    }
    ...
    public static boolean hasExplicitDtoDefault(VariableElement field, DtoBuilderDefault builderDefault) {
        ...
        return !builderDefault.stringValue().isEmpty() ||
                ...
                !builderDefault.enumValue().isEmpty() ||
                !builderDefault.value().isEmpty() ||
                isCollectionType(type) || isOptionalType(type);
    }
}
