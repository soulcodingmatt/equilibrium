...
public final class ValidationPairConflictChecker {
  ...
  public static String checkPairConflict(String fieldName, ValidationInfo a, ValidationInfo b) {
    ...
    String c = checkSignContradictions(fieldName, typeA, typeB);
    if (c != null) {
      return c;
    }
    c = checkTemporalContradictions(fieldName, typeA, typeB);
    if (c != null) {
      return c;
    }
    c = checkMinMaxOrder(fieldName, typeA, typeB, a, b);
    if (c != null) {
      return c;
    }
    c = checkMinVersusSign(fieldName, typeA, typeB, a, b);
    if (c != null) {
      return c;
    }
    c = checkMaxVersusSign(fieldName, typeA, typeB, a, b);
    if (c != null) {
      return c;
    }
  ...
  private static String checkMinMaxOrder(
    ...
    if (typeA.equals("Min") && typeB.equals("Max")) {
      return minGreaterThanMaxMessage(fieldName, (Min) a.annotation, (Max) b.annotation);
    }
    if (typeA.equals("Max") && typeB.equals("Min")) {
      return minGreaterThanMaxMessage(fieldName, (Min) b.annotation, (Max) a.annotation);
    }
    return null;
  }
  ...
  private static String checkMinVersusSign(
    ...
    if (typeA.equals("Min") && typeB.equals(POSITIVE)) {
      return minPositiveConflict(fieldName, (Min) a.annotation);
    }
    if (typeA.equals(POSITIVE) && typeB.equals("Min")) {
      return minPositiveConflict(fieldName, (Min) b.annotation);
    }
    if (typeA.equals("Min") && typeB.equals(NEGATIVE)) {
      return minNegativeConflict(fieldName, (Min) a.annotation);
    }
    if (typeA.equals(NEGATIVE) && typeB.equals("Min")) {
      return minNegativeConflict(fieldName, (Min) b.annotation);
    }
    return null;
  }
  ...
  private static String checkMaxVersusSign(
    ...
    if (typeA.equals("Max") && typeB.equals(POSITIVE)) {
      return maxPositiveConflict(fieldName, (Max) a.annotation);
    }
    if (typeA.equals(POSITIVE) && typeB.equals("Max")) {
      return maxPositiveConflict(fieldName, (Max) b.annotation);
    }
    if (typeA.equals("Max") && typeB.equals(NEGATIVE)) {
      return maxNegativeConflict(fieldName, (Max) a.annotation);
    }
    if (typeA.equals(NEGATIVE) && typeB.equals("Max")) {
      return maxNegativeConflict(fieldName, (Max) b.annotation);
    }
    return null;
  }
