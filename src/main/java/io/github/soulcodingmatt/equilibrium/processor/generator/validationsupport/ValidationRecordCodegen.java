...
/**
 * Emits type-safe Jakarta validation annotations for Record components from {@link ValidateRecord}.
 */
public final class ValidationRecordCodegen {

  private ValidationRecordCodegen() {}

  public static void writeTypeSafeRecordValidations(
      Writer writer, ValidateRecord validateAnnotation) throws IOException {
    writeRecordNotNull(writer, validateAnnotation);
    writeRecordNotBlank(writer, validateAnnotation);
    writeRecordSize(writer, validateAnnotation);
    writeRecordMin(writer, validateAnnotation);
    writeRecordMax(writer, validateAnnotation);
    writeRecordEmail(writer, validateAnnotation);
    writeRecordPattern(writer, validateAnnotation);
    writeRecordNotEmpty(writer, validateAnnotation);
    writeRecordPositive(writer, validateAnnotation);
    writeRecordPositiveOrZero(writer, validateAnnotation);
    writeRecordNegative(writer, validateAnnotation);
    writeRecordNegativeOrZero(writer, validateAnnotation);
    writeRecordDigits(writer, validateAnnotation);
    writeRecordPast(writer, validateAnnotation);
    writeRecordFuture(writer, validateAnnotation);
    writeRecordPastOrPresent(writer, validateAnnotation);
    writeRecordFutureOrPresent(writer, validateAnnotation);
  }
  ...
  private static void writeRecordSize(Writer writer, ValidateRecord validateAnnotation)
      throws IOException {
  ...
  private static void writeRecordMin(Writer writer, ValidateRecord validateAnnotation)
      throws IOException {
  ...
  private static void writeRecordMax(Writer writer, ValidateRecord validateAnnotation)
      throws IOException {
  ...
  private static void writeRecordPattern(Writer writer, ValidateRecord validateAnnotation)
      throws IOException {
  ...
  private static void writeRecordDigits(Writer writer, ValidateRecord validateAnnotation)
      throws IOException {
  ...
  public static void addTypeSafeRecordValidationImports(
      Set<String> validationImports, ValidateRecord validateAnnotation) {
    ValidationTypeSafeImports.addForRecord(validationImports, validateAnnotation);
  }
}
