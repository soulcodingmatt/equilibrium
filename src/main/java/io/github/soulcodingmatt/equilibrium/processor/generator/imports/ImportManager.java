...
public final class ImportManager {
    ...
    public Set<String> getFiltered() {
        return imports.stream().filter(this::isValidImport).collect(Collectors.toCollection(HashSet::new));
    }
    ...
    private boolean isValidImport(String type) {
        ...
        // Allow java.lang only for nested/inner class import edge cases handled previously via contains("$")
