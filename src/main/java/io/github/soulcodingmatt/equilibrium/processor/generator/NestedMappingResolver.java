        ...
        try {
            ...
            if (typeMirror.getKind() == TypeKind.ERROR || typeMirrorString.contains("<any?>")) {
                ...
                try {
                    ...
                    if (annotationString.contains(DtoGenerator.DTO_CLASS) && annotationString.contains(".class")) {
                        int start = annotationString.indexOf(DtoGenerator.DTO_CLASS) + DtoGenerator.DTO_CLASS.length();
